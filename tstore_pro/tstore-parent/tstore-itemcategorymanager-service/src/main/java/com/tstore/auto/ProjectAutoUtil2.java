...
public class ProjectAutoUtil2 {
	...
	// 定义模块
	private static String beanModel = "ItemCategory";
	private static String tablename = "tb_item_category";
	private static String model = beanModel.toLowerCase();
	private static String author = "xiaoteng";
	private static String description = "用户实体";
	private static String phone = "18820148139";
	...
	public static List<Map<String, String>> loadTable() {
		try {
			...
			Connection connection = DriverManager.getConnection(
					"jdbc:mysql://localhost:3306/tstore?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull",
					"root", "root");
	...
	public static void loadTemplate(List<Map<String, String>> maps, String packagename, String filename,
			String template) {
		try {
	...
	public static void main(String[] args) throws IOException {
		...
		String pojo = "src/main/java/com/tstore/pojo";
		loadTemplate(maps, pojo, beanModel + ".java", "pojo.tml");
		String mapper = "src/main/java/com/tstore/mapper";
		...
		// service
		String service = "src/main/java/com/tstore/service/" + model;
		loadTemplate(maps, service, "I" + beanModel + "Service.java", "service.tml");
		String serviceimpl = "src/main/java/com/tstore/service/" + model;
		loadTemplate(maps, serviceimpl, beanModel + "ServiceImpl.java", "serviceImpl.tml");

		// vo
		String vo = "src/main/java/com/tstore/vo";
		loadTemplate(maps, vo, beanModel + "Vo.java", "vo.tml");

		// controller
		String controller = "src/main/java/com/tstore/controller/" + model;
		...
		// listtag
		// String listtag = "src/main/java/com/tstore/tag/"+model;
		// loadTemplate(maps,listtag,beanModel+"ListTag.java","listtag.tml");

		// benatag
		// String benatag = "src/main/java/com/tstore/tag/"+model;
