...
public class ProjectAutoUtil2 {
	...
	private static String description = "内容管理";
	...
	public static List<Map<String,String>> loadTable() {
		try {
			...
			Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/tstore?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull", "root","root");
